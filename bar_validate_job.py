# this script checks each day has the expected number of minutes in the trading period
# if a given day has less minutes it requests all data for the day and loads it.
from typing import NamedTuple, Optional
from sqlalchemy import select, text, func
from sqlalchemy.orm import Session
from databases.trade.market_data import Calendar, Bars, PerBrokerAssetInfo, Assets, marketDataEngine
from datetime import datetime, timedelta
from pandas import Interval, Timestamp, DataFrame
